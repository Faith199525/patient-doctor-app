...
class OpticalServiceRequest extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    */
    ...
    protected function message($notifiable)
    {
        if ($notifiable->hasRole('doctor')){
            ...
            $message = 'Optical Service Appointment Booking from '.$appointeeName;
            ...
            $message = 'Your Optical Service Appointment Booking has been confirmed by '.$appointerName;
