...
class DentalServiceRequest extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    */
    ...
    protected function message($notifiable)
    {
        if ($notifiable->hasRole('doctor')){
            ...
            $message = 'Dental Service Appointment Booking from '.$appointeeName;
            ...
            $message = 'Your Dental Service Appointment Booking has been confirmed by '.$appointerName;
